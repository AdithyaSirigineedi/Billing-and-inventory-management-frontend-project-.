...
const VendorHome = () => {
        ...
        <>
            <header className="navbar">
                ...
                <ul className="nav-links">
                    <li>Home</li>
                    <li onClick={onAddProduct}>Add Products</li>
  ...
  <div className="faq-left">
    ...
    <h2 className="faq-heading">For Vendors & Sellers</h2>
    <div className="faq-item">
      <details>
        <summary>How do I list a new product?</summary>
        <br />
        <p>Sign in to your vendor account and click “Add Products” from the navigation bar.</p>
      </details>
      <details>
        <summary>Can I edit or remove a product after posting?</summary>
        <br />
        <p>Yes, go to your product dashboard to update or delete listings anytime.</p>
      </details>
      <details>
        <summary>Is there a limit to how many products I can add?</summary>
        <br />
        <p>No, vendors can list an unlimited number of products as long as they meet our guidelines.</p>
      </details>
      <details>
        <summary>How do I track my sales or product performance?</summary>
        <br />
        <p>Navigate to your vendor dashboard where you can view real-time analytics and order history.</p>
      </details>
      <details>
        <summary>Are there any fees for listing products?</summary>
        <br />
        <p>Basic listings are free. Premium promotion options are available for a fee.</p>
      </details>
    </div>
  </div>
